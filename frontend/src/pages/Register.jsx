...
function Register() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-cream px-4">
      ...
      >
        <h2 className="text-3xl font-bold mb-2 text-darkText">Register</h2>
        <p className="text-softText mb-6">Create your Dairy account</p>
        ...
        <p className="text-center mt-5 text-softText">
          ...
          <Link to="/login" className="text-sky font-semibold">
            Login
          </Link>
        </p>
      </form>
